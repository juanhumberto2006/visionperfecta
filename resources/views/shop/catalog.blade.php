                    ...
                    <div class="card-body">
                        <div class="list-group">
                            ...
                            @foreach ($categorias as $categoria)
                                <a href="{{ route('shop.category', $categoria->id) }}"
                        ...
                        <div class="col">
                            <div class="card h-100 product-card">
                                @php
                                        ...
                                        @endphp
                                        <img src="{{ $isExternal ? $imagenUrl : asset('storage/' . $imagenUrl) }}" class="card-img-top product-img"
                                    alt="{{ $producto->nombre }}" onerror="this.src='{{ asset('img/no-image.png') }}'">
                                <div class="card-body">
                                ...
                                <div class="card-footer bg-white border-top-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{ route('shop.product', $producto->id) }}"
