                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre"
                                        placeholder="Ingrese el nombre de la categoria" value="{{ $categoria->nombre }}" readonly>
                                </div>
                                @error('nombre')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="descripcion" id="descripcion" rows="3"
                                    placeholder="Ingrese una breve descripcion de la categoria" readonly>{{ $categoria->descripcion }}</textarea>
                            </div>
                        </div>
                    </div>
                    <hr>
