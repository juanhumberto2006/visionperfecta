    ...
    <div class="col-md-12">
        <div class="card  card-success">
            <div class="card-header">
                <h3 class="card-title"><b>Editar un producto</b></h3>
                                        ...
                                        <label for="estado">Estado <br><b style="color: red">(*)</b></label>
                                            <div class="input-group mb-3">
                                                ...
                                                <select name="estado" id="" class="form-control">
                                                    <option value="">Seleccione una unidad de medida</option>
                                                    <option value="1" {{ old('activa',$producto->estado) == 1 ? 'selected' : '' }}>Activo</option>
                                                    <option value="0" {{ old('activa',$producto->estado) == 0 ? 'selected' : '' }}>Inactivo</option>
                                                </select>
                                            </div>
                                        @error('stock_maximo')
                                            <small style="color: red">{{ $message }}</small>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div id="inputUrl" style="display: none;">
                                            <div class="input-group mb-3">
                                                ...
                                                <input style="text-align: center;" type="text" class="form-control"
                                                    id="imagen_url" name="imagen_url" placeholder="https://images.unsplash.com/..." value="{{ $producto->imagen }}"> 
                                            </div>
                                        </div>
                                        ...
                                        @endphp
                                        <img id="ImgPreview" src="{{ $isExternal ? $imagenUrl : asset('storage/' . $producto->imagen) }}" width="100%" height="auto" alt="Vista previa de la imagen" onerror="this.src='{{ asset('img/no-image.png') }}'">
                                        <script>
